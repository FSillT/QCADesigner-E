...
enum
  ...
  QCAD_CELL_PROPERTY_IGNOREENERGY
  } ;
...
static void qcad_cell_class_init (GObjectClass *klass, gpointer data)
  ...
  g_object_class_install_property (G_OBJECT_CLASS (klass), QCAD_CELL_PROPERTY_IGNOREENERGY,
    g_param_spec_boolean ("ignore_energy", _("ignore_energy"), _("Cell Ignore Energy"),
...
static void qcad_cell_set_property (GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
  ...
  switch (property_id)
    ...
    case QCAD_CELL_PROPERTY_IGNOREENERGY:
      qcad_cell_set_ignore_energy (cell, g_value_get_boolean (value)) ;
      DBG_VAL (fprintf (stderr, "qcad_cell_set_property:Setting Ignore Energy to %s\n", g_value_get_boolean (value)?"True":"False")) ;
      break ;
    }
...
static void qcad_cell_get_property (GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
  ...
  switch (property_id)
    ...
    case QCAD_CELL_PROPERTY_IGNOREENERGY:
      g_value_set_boolean (value, cell->cell_options.ignore_energy) ;
      break ;
...
static gboolean unserialize (QCADDesignObject *obj, FILE *fp)
  ...
  cell->cell_options.ignore_energy = FALSE;
...
static gboolean properties (QCADDesignObject *obj, GtkWidget *widget)
  ...
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (dialog.chkignore_energy), cell->cell_options.ignore_energy );
...
static void default_properties_apply (gpointer data)
  ...
  cklass->default_cell_options.ignore_energy = FALSE ;
  }
#endif /* def GTK_GUI */
...
static void create_properties_dialog (PROPERTIES *dialog)
  {
  GtkWidget *tbl = NULL, *tblFm = NULL, *tbllbl = NULL, *tblBig = NULL, *chkignore_energy;
  ...
  gtk_table_attach (GTK_TABLE (tblBig), dialog->chkignore_energy, 0, 1, 2, 3,
    (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
    (GtkAttachOptions)(GTK_EXPAND | GTK_FILL), 2, 2) ;  
...
// make selective fields active (or hide)
static void cell_mode_toggled (GtkWidget *widget, gpointer data)
  {
...
void qcad_cell_set_ignore_energy (QCADCell *cell, gboolean ignore_energy)
  {
  cell->cell_options.ignore_energy = ignore_energy ;
  if (ignore_energy == TRUE) {
    memcpy (&(QCAD_DESIGN_OBJECT (cell)->clr), &clrPurple, sizeof (GdkColor)) ;
    if (NULL != cell->label)
      memcpy (&(QCAD_DESIGN_OBJECT (cell->label)->clr), &clrPurple, sizeof (GdkColor)) ;
  }
}
